...
our %recast_plugin;
our (@installedSoftware,@portScanner,@vuln_entries,@host_scan_data,@host_vuln_data,@WinWirelessSSID,@cpe_data,@PCIDSS,@ADUsers,@ScanInfo,@MS_Process_Info);
...
sub store_vuln{
    ...
    foreach my $vuln (@vuln_array){
		...
		if ($vuln->{'see_also'} eq ''){$vuln->{'see_also'} = 'N/A'}
        ...
        if($vuln->{-pluginFamily} ne "Policy Compliance"){
            my $r = "$file,$name,$host_fqdn,$vuln->{'-pluginID'},$vuln->{'-protocol'},$vuln->{'-port'},$vuln->{'-severity'},$plugin_name,$vuln->{exploitability_ease},$vuln->{exploit_available},$vuln->{exploit_framework_canvas},$vuln->{exploit_framework_metasploit},$vuln->{exploit_framework_core},$vuln->{metasploit_name},$vuln->{canvas_package},$vuln->{'-pluginFamily'},$vuln->{cvss_base_score},$vuln->{cvss_vector},$vuln->{cvss_temporal_score},$vuln->{plugin_output}";
            push @host_scan_data,$r;
        }
		
		if($vuln->{-pluginFamily} ne "Policy Compliance"){
            my $v = "$vuln->{'-pluginID'},$cve,$vuln->{cvss_base_score},$vuln->{risk_factor},$name,$mac_address,$vuln->{'-protocol'},$vuln->{'-port'},$plugin_name,$vuln->{'synopsis'},$vuln->{'description'},$vuln->{'solution'},'$vuln->{'see_also'}',$vuln->{plugin_output}";
            push @host_vuln_data,$v;
        }
...
foreach my $host (@host_data){
    ...
    if($host->{'aix_local_security_checks'}->[0] ne ""){store_vuln($host->{'aix_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'amazon_linux_local_security_checks'}->[0] ne ""){store_vuln($host->{'amazon_linux_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'backdoors'}->[0] ne ""){store_vuln($host->{'backdoors'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'centos_local_security_checks'}->[0] ne ""){store_vuln($host->{'centos_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'cgi_abuses'}->[0] ne ""){store_vuln($host->{'cgi_abuses'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'cgi_abuses_xss'}->[0] ne ""){store_vuln($host->{'cgi_abuses_xss'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'cisco'}->[0] ne ""){store_vuln($host->{'cisco'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'databases'}->[0] ne ""){store_vuln($host->{'databases'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'debian_local_security_checks'}->[0] ne ""){store_vuln($host->{'debian_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'default_unix_accounts'}->[0] ne ""){store_vuln($host->{'default_unix_accounts'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'denial_of_service'}->[0] ne ""){store_vuln($host->{'denial_of_service'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'dns'}->[0] ne ""){store_vuln($host->{'dns'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'F5_Networks_Local_Security_Checks'}->[0] ne ""){store_vuln($host->{'F5_Networks_Local_Security_Checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'fedora_local_security_checks'}->[0] ne ""){store_vuln($host->{'fedora_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'finger_abuses'}->[0] ne ""){store_vuln($host->{'finger_abuses'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'firewalls'}->[0] ne ""){store_vuln($host->{'firewalls'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'freebsd_local_security_checks'}->[0] ne ""){store_vuln($host->{'freebsd_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'ftp'}->[0] ne ""){store_vuln($host->{'ftp'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'gain_a_shell_remotely'}->[0] ne ""){store_vuln($host->{'gain_a_shell_remotely'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'general'}->[0] ne ""){store_vuln($host->{'general'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'gentoo_local_security_checks'}->[0] ne ""){store_vuln($host->{'gentoo_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'hp_ux_local_security_checks'}->[0] ne ""){store_vuln($host->{'hp_ux_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'Huawei_Local_Security_Checks'}->[0] ne ""){store_vuln($host->{'Huawei_Local_Security_Checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'IncidentResponse'}->[0] ne ""){store_vuln($host->{'IncidentResponse'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'junos_local_security_checks'}->[0] ne ""){store_vuln($host->{'junos_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'macos_x_local_security_checks'}->[0] ne ""){store_vuln($host->{'macos_x_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'mandriva_local_security_checks'}->[0] ne ""){store_vuln($host->{'mandriva_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'misc'}->[0] ne ""){store_vuln($host->{'misc'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'mobile_devices'}->[0] ne ""){store_vuln($host->{'mobile_devices'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'netware'}->[0] ne ""){store_vuln($host->{'netware'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'OracleVM_Local_Security_Checks'}->[0] ne ""){store_vuln($host->{'OracleVM_Local_Security_Checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'oracle_linux_local_security_checks'}->[0] ne ""){store_vuln($host->{'oracle_linux_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'Palo_Alto_Local_Security_Checks'}->[0] ne ""){store_vuln($host->{'Palo_Alto_Local_Security_Checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'peer_to_peer_file_sharing'}->[0] ne ""){store_vuln($host->{'peer_to_peer_file_sharing'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'policy_compliance'}->[0] ne ""){store_vuln($host->{'policy_compliance'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'port_scanners'}->[0] ne ""){store_vuln($host->{'port_scanners'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'red_hat_local_security_checks'}->[0] ne ""){store_vuln($host->{'red_hat_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'rpc'}->[0] ne ""){store_vuln($host->{'rpc'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'scada'}->[0] ne ""){store_vuln($host->{'scada'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'scientific_linux_local_security_checks'}->[0] ne ""){store_vuln($host->{'scientific_linux_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'service_detection'}->[0] ne ""){store_vuln($host->{'service_detection'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'settings'}->[0] ne ""){store_vuln($host->{'settings'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'slackware_local_security_checks'}->[0] ne ""){store_vuln($host->{'slackware_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'smtp_problems'}->[0] ne ""){store_vuln($host->{'smtp_problems'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'snmp'}->[0] ne ""){store_vuln($host->{'snmp'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'solaris_local_security_checks'}->[0] ne ""){store_vuln($host->{'solaris_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'suse_local_security_checks'}->[0] ne ""){store_vuln($host->{'suse_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'ubuntu_local_security_checks'}->[0] ne ""){store_vuln($host->{'ubuntu_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'vmware_esx_local_security_checks'}->[0] ne ""){store_vuln($host->{'vmware_esx_local_security_checks'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'web_servers'}->[0] ne ""){store_vuln($host->{'web_servers'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'windows_microsoft_bulletins'}->[0] ne ""){store_vuln($host->{'windows_microsoft_bulletins'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"});print "";}
    if($host->{'windows_user_management'}->[0] ne ""){store_vuln($host->{'windows_user_management'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"})}
    if($host->{'windows'}->[0] ne ""){store_vuln($host->{'windows'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"})}
    if($host->{'port_scan'}->[0] ne ""){store_vuln($host->{'port_scan'},$host->{'file'},$host->{name},$host->{'host-fqdn'},$host->{"netbios-name"},$host->{"operating-system"},$host->{"mac-address"})}
    my @MSWinAccounts;
    my $domain_user_list;
    my $local_user_list;
    my $password_policy;
...
print "Storing Unique Vulnerabilities Per Host Table\n";
my $host_scan_data_ctr = 2;
my $host_scan_data_worksheet = $workbook->add_worksheet('Unique Vulnerabilities Per Host');
$host_scan_data_worksheet->write_url( 'A1', $home_url, $url_format, $_);
$host_scan_data_worksheet->keep_leading_zeros();
$host_scan_data_worksheet->write(1, 0, 'PluginID',$center_border6_format);
$host_scan_data_worksheet->write(1, 1, 'CVE',$center_border6_format);
$host_scan_data_worksheet->write(1, 2, 'CVSS',$center_border6_format);
$host_scan_data_worksheet->write(1, 3, 'Risk',$center_border6_format);
$host_scan_data_worksheet->write(1, 4, 'Host',$center_border6_format);
$host_scan_data_worksheet->write(1, 5, 'MAC Address',$center_border6_format);
$host_scan_data_worksheet->write(1, 6, 'Protocol',$center_border6_format);
$host_scan_data_worksheet->write(1, 7, 'Port',$center_border6_format);
$host_scan_data_worksheet->write(1, 8, 'Plugin Name',$center_border6_format);
$host_scan_data_worksheet->write(1, 9, 'Synopsis',$center_border6_format);
$host_scan_data_worksheet->write(1, 10, 'Description',$center_border6_format);
$host_scan_data_worksheet->write(1, 11, 'Solution',$center_border6_format);
$host_scan_data_worksheet->write(1, 12, 'See Also',$center_border6_format);
$host_scan_data_worksheet->write(1, 13, 'Plugin Output',$center_border6_format);
$host_scan_data_worksheet->autofilter('A2:M2');
$host_scan_data_worksheet->set_tab_color('purple');
$host_scan_data_worksheet->set_column('A:A', 5);
$host_scan_data_worksheet->set_column('B:B', 14.5);
$host_scan_data_worksheet->set_column('C:C', 3.5);
$host_scan_data_worksheet->set_column('D:D', 8.5);
$host_scan_data_worksheet->set_column('E:E', 13);
$host_scan_data_worksheet->set_column('F:F', 10);
$host_scan_data_worksheet->set_column('G:G', 7);
$host_scan_data_worksheet->set_column('H:H', 57);
$host_scan_data_worksheet->set_column('I:N', 28);

my $h_tmp = @host_vuln_data;
my $h_tmp2 = $h_tmp;
my $table_cnt = 2;
if($h_tmp > 100000){
...
foreach (@host_vuln_data){
    ...
    $host_scan_data_worksheet->write($host_scan_data_ctr, 9, $tmp[9],$cell_format);
    $host_scan_data_worksheet->write($host_scan_data_ctr, 10, $tmp[10],$cell_format);
    $host_scan_data_worksheet->write($host_scan_data_ctr, 11, $tmp[11],$cell_format);
	$host_scan_data_worksheet->write($host_scan_data_ctr, 12, $tmp[12],$cell_format);
	$host_scan_data_worksheet->write($host_scan_data_ctr, 12, $tmp[13],$cell_format);
    ++$host_scan_data_ctr;
...
my $host_scan_data_ctr = 2;
my $host_scan_data_worksheet = $workbook->add_worksheet('Exploit Availability');
$host_scan_data_worksheet->write_url( 'A1', $home_url, $url_format, $_);
$host_scan_data_worksheet->keep_leading_zeros();
...
$host_scan_data_worksheet->write(1, 7, 'Plugin Name',$center_border6_format);
$host_scan_data_worksheet->write(1, 8, 'Exploitability Ease',$center_border6_format);
$host_scan_data_worksheet->write(1, 9, 'Exploit Available',$center_border6_format);
$host_scan_data_worksheet->write(1, 10, 'Exploit Framework Canvas',$center_border6_format);
$host_scan_data_worksheet->write(1, 11, 'Exploit Framework Metasploit',$center_border6_format);
$host_scan_data_worksheet->write(1, 12, 'Exploit Framework Core',$center_border6_format);
$host_scan_data_worksheet->write(1, 13, 'Metasploit Name',$center_border6_format);
$host_scan_data_worksheet->write(1, 14, 'Canvas Package',$center_border6_format);
$host_scan_data_worksheet->write(1, 15, 'Plugin Family',$center_border6_format);
$host_scan_data_worksheet->write(1, 16, 'CVSS Vector',$center_border6_format);
$host_scan_data_worksheet->write(1, 17, 'CVSS Base Score',$center_border6_format);
$host_scan_data_worksheet->write(1, 18, 'CVSS Temporal Score',$center_border6_format);
...
$host_scan_data_worksheet->set_column('A:A', 5);
$host_scan_data_worksheet->set_column('B:B', 13);
$host_scan_data_worksheet->set_column('C:C', 8);
$host_scan_data_worksheet->set_column('D:G', 10);
$host_scan_data_worksheet->set_column('G:G', 8);
$host_scan_data_worksheet->set_column('H:H', 54);
$host_scan_data_worksheet->set_column('I:I', 30);
$host_scan_data_worksheet->set_column('J:J', 19);
$host_scan_data_worksheet->set_column('K:K', 29);
$host_scan_data_worksheet->set_column('L:P', 25);
...
foreach (@host_scan_data){
    ...
    $host_scan_data_worksheet->write($host_scan_data_ctr, 11, $tmp[11],$cell_format);
    $host_scan_data_worksheet->write($host_scan_data_ctr, 12, $tmp[12],$cell_format);
    $host_scan_data_worksheet->write($host_scan_data_ctr, 13, $tmp[13],$cell_format);
    $host_scan_data_worksheet->write($host_scan_data_ctr, 14, $tmp[14],$cell_format);
    $host_scan_data_worksheet->write($host_scan_data_ctr, 15, $tmp[15],$cell_format);
    $host_scan_data_worksheet->write($host_scan_data_ctr, 16, $tmp[16],$cell_format);
    $host_scan_data_worksheet->write($host_scan_data_ctr, 17, $tmp[17],$cell_format);
    $host_scan_data_worksheet->write($host_scan_data_ctr, 18, $tmp[18],$cell_format);
...
if($ScanInfo[0] ne ""){
    ...
    my $ScanInfo_worksheet = $workbook->add_worksheet('Scan Info');
...
my $HostConfigData_worksheet = $workbook->add_worksheet('Host Config Data');
...
if ($portScanner[0] ne "") {
    ...
    my $portScanData_worksheet = $workbook->add_worksheet('Port Scan Data');
...
if ($installedSoftware[0] ne "") {
    ...
    my $InstalledSoftwareData_worksheet = $workbook->add_worksheet('Installed Software Data');
...
if($PCIDSS[0] ne "") {
    ...
    my $PCIDSS_ctr = 2;
    our $PCIDSS_worksheet = $workbook->add_worksheet('PCIDSS Policy');
...
if($EnumLocalGrp[0] ne "") {
    ...
    my $EnumLocalGrpworksheet = $workbook->add_worksheet('Enum Local Group');
...
my $UserAccountData_worksheet = $workbook->add_worksheet('User Account Data');
...
if ($isCompliancePresent == 1) {
    foreach my $k (keys %complaince){
        if ($complaince{"$k"}->[0] ne "") {
            $PolicySummaryReport_worksheet = $workbook->add_worksheet('Policy Summary Report Data');
...
my $HostSummaryReport_worksheet = $workbook->add_worksheet('Host Summary Report Data');
...
foreach my $entry (@host_sum_array){
    ...
    my $chart_sheet_name = 'Host Summary Report Data';
    $chart->add_series(
        name       => $chart_title,
...
$Home_worksheet->write($Home_cnt, 1, "\=COUNTIF\('Host Config Data'\!M3\:M$total_discovered_row\,\"\>0\"\)");
++$Home_cnt;
$Home_worksheet->write($Home_cnt, 0, "Number of System with a High(3) Severity Vulnerability");
$Home_worksheet->write($Home_cnt, 1, "\=COUNTIF\('Host Config Data'\!L3\:L$total_discovered_row\,\"\>0\"\)");
++$Home_cnt;
$Home_worksheet->write($Home_cnt, 0, "Number of System with a Medium(2) Severity Vulnerability");
$Home_worksheet->write($Home_cnt, 1, "\=COUNTIF\('Host Config Data'\!K3\:K$total_discovered_row\,\"\>0\"\)");
++$Home_cnt;
$Home_worksheet->write($Home_cnt, 0, "Number of System with a Low(1) Severity Vulnerability");
$Home_worksheet->write($Home_cnt, 1, "\=COUNTIF\('Host Config Data'\!J3\:J$total_discovered_row\,\"\>0\"\)");
++$Home_cnt;
$Home_worksheet->write($Home_cnt, 0, "Number of System with a Informational(NONE-0) Severity Vulnerability");
$Home_worksheet->write($Home_cnt, 1, "\=COUNTIF\('Host Config Data'\!I3\:I$total_discovered_row\,\"\>0\"\)");
++$Home_cnt;
++$Home_cnt;
